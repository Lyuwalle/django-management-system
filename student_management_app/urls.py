...
# Add these lines in the "URLS for Staff" section
    ...
    path('staff_add_student_save/', StaffViews.staff_add_student_save, name="staff_add_student_save"),
    path('staff_edit_student/<student_id>', StaffViews.staff_edit_student, name="staff_edit_student"),
    path('staff_edit_student_save/', StaffViews.staff_edit_student_save, name="staff_edit_student_save"),
    path('staff_delete_student/<student_id>/', StaffViews.staff_delete_student, name="staff_delete_student"),
